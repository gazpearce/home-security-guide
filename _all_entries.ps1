...
@{
    ...
    fq=@(
        ...
        @{q="Can Matter devices work without internet in the UK?";a="Yes  -  Matter operates locally on your home network using Thread or Wi-Fi. Even if your broadband goes down, Matter devices continue responding to local automations and voice commands through the hub."});rt=@("Smart Home Hub Installation Guide UK",
        "Zigbee vs Z-Wave vs Thread UK Guide",
        "Smart Home Network Requirements UK");rf=@("01-smart-home-hub-installation-guide-uk.md",
        "18-zigbee-vs-z-wave-vs-thread-uk-guide.md",
        "15-smart-home-network-requirements-uk.md"
    );
},
